module WebhostinghubGlyphs
  module Rails
    module IconHelper
      ...
      # Examples
      #
      #   whhg_icon "camera-retro"
      #   # => <i class="icon-camera-retro"></i>
      #
      #   whhg_icon "camera-retro", text: "Take a photo"
      #   # => <i class="icon-camera-retro"></i> Take a photo
      #
      #   whhg_icon "camera-retro 2x"
      #   # => <i class="icon-camera-retro icon-2x"></i>
      #   whhg_icon ["camera-retro", "4x"]
      #   # => <i class="icon-camera-retro icon-4x"></i>
      #   whhg_icon "spinner spin large"
      #   # => <i class="icon-spinner icon-spin icon-large">
      #
      #   whhg_icon "quote-left 4x muted", class: "pull-left"
      #   # => <i class="icon-quote-left icon-4x icon-muted pull-left"></i>
      #
      #   whhg_icon "user", data: { id: 123 }
      #   # => <i class="icon-user" data-id="123"></i>
      #
      #   content_tag(:li, whhg_icon("ok li", text: "Bulleted list item"))
      #   # => <li><i class="icon-ok icon-li"></i> Bulleted list item</li>
      def whhg_icon(names = "flag", options = {})
      ...
      # Examples
      #
      #   whhg_stacked_icon "twitter", base: "check-empty"
      #   # => <span class="icon-stack">
      #   # =>   <i class="icon-check-empty icon-stack-base"></i>
      #   # =>   <i class="icon-twitter"></i>
      #   # => </span>
      #
      #   whhg_stacked_icon "terminal light", base: "sign-blank", class: "pull-right", text: "Hi!"
      #   # => <span class="icon-stack pull-right">
      #   # =>   <i class="icon-sign-blank icon-stack-base"></i>
      #   # =>   <i class="icon-terminal icon-light"></i>
      #   # => </span> Hi!
      #
      #   whhg_stacked_icon "camera", base: "ban-circle", reverse: true
      #   # => <span class="icon-stack">
      #   # =>   <i class="icon-camera"></i>
      #   # =>   <i class="icon-ban-circle icon-stack-base"></i>
      #   # => </span>
      def whhg_stacked_icon(names = "flag", options = {})
        ...
        base = whhg_icon(base_names, options.delete(:base_options) || {})
        icon = whhg_icon(names, options.delete(:icon_options) || {})
        icons = [base, icon]
