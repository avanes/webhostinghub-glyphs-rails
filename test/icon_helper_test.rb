...
class WebhostinghubGlyphs::Rails::IconHelperTest < ActionView::TestCase

  test "#whhg_icon with no args should render a flag icon" do
    assert_icon i("icon-flag")
  end

  test "#whhg_icon should render different individual icons" do
  ...
  test "#whhg_icon should render icons with multiple modifiers" do
  ...
  test "#whhg_icon should render icons with array modifiers" do
    assert_icon i("icon-flag"),                      ["flag"]
  ...
  test "#whhg_icon should incorporate additional class styles" do
  ...
  test "#whhg_stacked_icon should incorporate additional class styles" do
  ...
  test "#whhg_stacked_icon should reverse the stack" do
  ...
  test "#whhg_stacked_icon should html escape text" do
  ...
  test "#whhg_stacked_icon should not html escape safe text" do
    expected = %(<span class="icon-stack">#{i("icon-check-empty icon-stack-base")}#{i("icon-twitter")}</span> <script>)
    assert_stacked_icon expected, "twitter", :base => "check-empty", :text => "<script>".html_safe
  end

  test "#whhg_stacked_icon should accept options for base and main icons" do
  ...
  test "#whhg_stacked_icon should pass all other options through" do
  ...
  def assert_icon(expected, *args)
    message = "`whhg_icon(#{args.inspect[1...-1]})` should return `#{expected}`"
    assert_dom_equal expected, whhg_icon(*args), message
  end

  def assert_stacked_icon(expected, *args)
    message = "`whhg_stacked_icon(#{args.inspect[1...-1]})` should return `#{expected}`"
    assert_dom_equal expected, whhg_stacked_icon(*args), message
  end
